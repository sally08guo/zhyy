...
public class UnreadFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, AnnouceListAdapter.OnItemClickListener{
...
//    public static UnreadFragment newInstance(int type) {
...
//        initListData(FIRST_REFRESH, true);
//    }
...
//    private void deleteItem(String noticeCode, final int position) {
//        HashMap<String, String> params = new HashMap<>();
...
//                                detailsDialog.setOnConfirmListener(new DetailsDialog.onConfirmListener() {
//                                    @Override
...
//                                    jsonObject1.getString("FileName");
//                                }
//                            } else {
//                                Log.e("WQ", "进入详情服务");
//                                activityUtils.showToast(msg);
