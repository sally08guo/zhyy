...
public class SelectLCBAdapter extends BaseAdapter {
    ...
    public SelectLCBAdapter(Context context, List<LCB> list_user) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Log.e("状态", list_user.get(position).getIsCurrent());
        if (!list_user.get(position).getIsCurrent().equals("0")) {
