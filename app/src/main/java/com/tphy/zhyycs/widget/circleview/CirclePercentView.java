package com.tphy.zhyycs.widget.circleview;
...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mringColor = a.getColor(R.styleable.CirclePercentView_ringColor, 0xffafb4db);
        mBigColor = a.getColor(R.styleable.CirclePercentView_bigColor, 0xff6950a1);
        mSmallColor = a.getColor(R.styleable.CirclePercentView_smallColor, 0xff6950a1);
...
//            mHeight = height;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        sectorPaint.setColor(mringColor);
